...
public class Activity_histori_laporan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Histori Laporan");
    ...
    private void list_tl(){
        ...
        ApiClient.laporan_list_usr(this, mRecyclerView, list_tl, Activity_detail_laporanUsr.class, data_kosong);
    }
