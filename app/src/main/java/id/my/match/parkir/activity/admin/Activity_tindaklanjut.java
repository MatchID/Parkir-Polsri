...
public class Activity_tindaklanjut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Tindak Lanjut Laporan");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(resultCode == Activity.RESULT_OK){
            if(data.getStringExtra("status").equals("refresh")){
                list_tl();
            }
        }
    }
    ...
    private void list_tl(){
        ...
        ApiClient.laporan_list_adm(this, mRecyclerView, list_tl, Activity_detail_laporan.class, "TL2", data_kosong);
    }
