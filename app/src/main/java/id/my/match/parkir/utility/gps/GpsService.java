package id.my.match.parkir.utility.gps;

/*
 * Filename    : GpsService.java
 * Projectname : GPSTutorial
 * Date        : Nov 24, 2012 , 6:35:17 PM 
 * 
 * @author PratamaWijaya
 * 
 * class ini digunakan untuk Akses GPS dan segala macamnya..
 * 
 * class ini merupakan turunan dari class service dan mengImplement LocationListener
 */
...
public class GpsService extends Service implements LocationListener
{
	...
	private Location getLocation()
	{
		...
		if ( Build.VERSION.SDK_INT >= 23 &&
				ContextCompat.checkSelfPermission( this._context, android.Manifest.permission.ACCESS_FINE_LOCATION ) != PackageManager.PERMISSION_GRANTED &&
				ContextCompat.checkSelfPermission( this._context, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
