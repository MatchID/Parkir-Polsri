...
public class Activity_verifikasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Verifikasi Laporan");
    ...
    private void list_tl(){
        ...
        ApiClient.laporan_list_adm(this, mRecyclerView, list_tl, Activity_detail_laporan.class, "TL1", data_kosong);
    }
