...
public class Activity_salah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Laporan Salah");
    ...
    private void list_tl(){
        ...
        ApiClient.laporan_list_adm(this, mRecyclerView, list_tl, Activity_detail_laporan.class, "TL3", data_kosong);
    }
